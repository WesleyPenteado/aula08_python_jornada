...
def extrair_dados_e_consolidar(pasta: str) -> pd.DataFrame:
    '''
    Informe um caminho de pasta para extrair dados de todos os arquivos json e transformar em DataFrame
    '''
...
# Dunder method para isolar os testes e não sofrer interferência do código principal (dica)
